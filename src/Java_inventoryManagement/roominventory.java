...
public class roominventory {
     ...
     public boolean addproduct(String proname,int Quanitity){
        ...
        String addQue = "INSERT INTO `room`(`pname`, `qty`) VALUES ('"+proname+"','"+Quanitity+"' )";
      ...
      public boolean updateproduct(String Product , int Qty){
        ...
        PreparedStatement st;
        String updateQuery = "UPDATE room SET qty=qty+'"+Qty+"' where pname='"+Product+"'";
      ...
      public void fillRoomInventoryProductDetailsJTable(JTable table1){
